...
const guardar = async (e) => {
    ...
    try {
        ...
        const url = "/cruds_tarea/API/aplicacion/guardar";
        const config = {
            method: 'POST',
            body
        };
...
const buscar = async () => {
    try {
        const url = "/cruds_tarea/API/aplicacion/buscar";
        const config = {
            method: 'GET',
        };
...
const modificar = async (e) => {
    ...
    try {
        const body = new FormData(formulario);
        const url = "/cruds_tarea/API/aplicacion/modificar";
...
const eliminar = async (aplicacion) => {
    ...
    if (confirmacion.isConfirmed) {
        try {
            ...
            const url = "/cruds_tarea/API/aplicacion/eliminar"
            const config = {
                method: 'POST',
                body
            }
