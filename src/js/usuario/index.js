...
const guardar = async (e) => {
    ...
    try {
        ...
        const url = "/cruds_tarea/API/usuario/guardar";
        const config = {
            method: 'POST',
            body
        };
...
const buscar = async () => {
    try {
        const url = "/cruds_tarea/API/usuario/buscar";
        const config = {
            method: 'GET',
        };
...
const modificar = async (e) => {
    ...
    try {
        const body = new FormData(formulario);
        const url = "/cruds_tarea/API/usuario/modificar";
...
const eliminar = async (usuario) => {
    ...
    if (confirmacion.isConfirmed) {
        try {
            ...
            const url = "/cruds_tarea/API/usuario/eliminar"
            const config = {
                method: 'POST',
                body
            }
